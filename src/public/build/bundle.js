...
/***/ function(module, exports, __webpack_require__) {
	...
	var _triggerEvents2 = _interopRequireDefault(_triggerEvents);

	var _listenEvents = __webpack_require__(171);

	var _listenEvents2 = _interopRequireDefault(_listenEvents);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var socket = io(SOCKET_URL);

	(0, _triggerEvents2.default)(socket);
	(0, _listenEvents2.default)(socket);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ButtonContainer = __webpack_require__(161);

	var _ButtonContainer2 = _interopRequireDefault(_ButtonContainer);

	var _ConfigContainer = __webpack_require__(162);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.handlePositionChange = _this._handlePositionChange.bind(_this);
	    _this.handleScaleChange = _this._handleScaleChange.bind(_this);
	    _this.handleModeChange = _this._handleModeChange.bind(_this);
	    _this.handleOctaveChange = _this._handleOctaveChange.bind(_this);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ConfigContainer2.default, {
	  ...
	  _createClass(ButtonContainer, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        this.props.noteButtons.map(function (noteButton, index) {
	          return _react2.default.createElement(
	            Button,
	            { className: noteButton.isPushed ? 'active' : '', key: index, waves: 'light' },
	            'D:  ',
	            noteButton.degreeDisplay,
	            ', V: ',
	            noteButton.value,
	            ', N: ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noteWriter = __webpack_require__(163);
	...
	var ConfigContainer = function ConfigContainer(props) {
	  ...
	  var handleOctaveChange = function handleOctaveChange(e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		NoteWriter: __webpack_require__(164),
		scales: __webpack_require__(168),
		notes: __webpack_require__(167),
		modes: __webpack_require__(169),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteButton = __webpack_require__(165);
	var notes = __webpack_require__(167);
	var scales = __webpack_require__(168);
	...
	function notifyEventListeners(eventType, data) {
		...
		eventListenerIndexes.forEach(function (listenerIndex) {
			var listener = eventListeners[listenerIndex];
	...
	var NoteWriter = function () {
		...
		_createClass(NoteWriter, [{
			key: 'setupInitialNoteButtons',
			value: function setupInitialNoteButtons() {
			...
			key: 'setNoteButtonValues',
			value: function setNoteButtonValues() {
			...
			key: 'savePreviousConfigAndButtons',
			value: function savePreviousConfigAndButtons() {
			...
			key: 'handleKeyChange',
			value: function handleKeyChange(newKey) {
				this.config.key = newKey;
				notifyEventListeners('key_change', newKey);
			}
		}, {
			key: 'handleOctaveChange',
			value: function handleOctaveChange(newOctave) {
				this.config.octave = newOctave;
				notifyEventListeners('octave_change', newOctave);
			}
		}, {
			key: 'setNoteButtonsAfterConfigChange',
			value: function setNoteButtonsAfterConfigChange() {
				var self = this;
	   ...
	   */
			...
			key: 'handleNoteButtonDown',
			value: function handleNoteButtonDown(data) {
	   ...
	   */
			...
			key: 'handleNoteButtonUp',
			value: function handleNoteButtonUp(data) {
				var noteButtonIndex = data.noteButtonIndex;
				var noteButton = this.noteButtons[noteButtonIndex];
	   ...
	   */
			...
			key: 'setNote',
			value: function setNote(on, noteData) {
				var requiredKeys = ['noteButtonIndex', 'degreeIndex', 'degree', 'noteValue', 'channel', 'velocity', 'noteDisplay'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getNoteNameFromValue(value, octave, offset) {
		...
		var name = noteNames.filter(function (noteName) {
	...
	function getOffsetFromDegreeInScale(degree, scale) {
		...
		if (index < spacingLength) {
			...
			var octaveOffset = Math.floor(index / spacingLength);
			var adjustedIndex = index % spacingLength;
...
/***/ function(module, exports) {
	...
	var triggerEvents = function triggerEvents(socket) {
...
/***/ function(module, exports) {
	...
	var midiFrequencies = function getHertzFromMidiValue() {
		var midi = {};
		var a = 440;
	...
	var listenEvents = function listenEvents(socket) {
